...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "Learn how Dash Language School was built to bridge continents — helping ambitious Nigerians navigate European visa processes with confidence and clarity.",
};
