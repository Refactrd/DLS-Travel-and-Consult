...
const programLinks = [
  { label: "Study Abroad", href: "/programs" },
  { label: "Work & Training", href: "/programs" },
  { label: "Short-Term Travel", href: "/programs" },
  { label: "Voluntary Service", href: "/programs" },
  { label: "Family Reunification", href: "/programs" },
];

const contactItems = [
  {
    label: "dlstravelconsult@gmail.com",
    href: "mailto:dlstravelconsult@gmail.com",
    icon: "✉",
  },
  {
    label: "WhatsApp",
  ...
  {
    label: "Lagos: No 49 Bode Thomas, Surulere, Lagos, Nigeria",
    href: "https://maps.google.com/?q=49+Bode+Thomas+Surulere+Lagos+Nigeria",
    icon: "📍",
  },
  {
    label: "Europe: Alexanderstraße 11, Berlin, Germany",
    href: "https://maps.google.com/?q=Alexanderstrasse+11+Berlin+Germany",
    icon: "📍",
  },
  {
    label: "+49 176 8203 2720 (Appointments only)",
    href: "tel:+4917682032720",
    icon: "📞",
  },
];
...
const socialLinks = [
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/dls-travels-and-consult/",
    icon: <LinkedInIcon />,
  },
  {
    label: "Instagram",
    href: "https://www.instagram.com/dls_travelsandconsults?igsh=MW5idnVlZ281cW12cQ==",
    icon: <InstagramIcon />,
  },
  {
    label: "Twitter / X",
    href: "https://x.com/DlsTravels",
    icon: <TwitterIcon />,
  },
];
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle, #0D7EFF 0%, transparent 65%)",
          }}
        />
            ...
            <ul className="flex flex-col gap-3">
              {pageLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="font-body text-white text-sm hover:text-white transition-colors duration-150 flex items-center gap-2 group"
                  >
              ...
              {contactItems.map((item) => (
                <li key={item.label}>
                  <a
                    ...
                    className="font-body text-white text-sm hover:text-white transition-colors duration-150 flex items-start gap-2.5"
                  >
                    <span className="text-[#0D7EFF] mt-0.5 flex-shrink-0">
                      {item.icon}
                    </span>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-center gap-3">
          <p className="font-body text-white text-base text-center">
            © {new Date().getFullYear()} {" "}DLS Travel &amp; Consult. All rights
            reserved.
          </p>
