    ...
    <>
      ...
      <section className="relative w-full min-h-[620px] flex items-center justify-center overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, rgba(5,5,40,0.45) 0%, rgba(5,5,40,0.58) 100%)",
          }}
        />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-12 items-start">
            ...
            <div className="space-y-16">
                ...
                <div className="space-y-3">
                  {country.programs.map((prog) => (
                    ...
                    >
                      ...
                      <div>
                        <p className="font-display font-semibold text-gray-800 text-[15px] mb-0.5">
                          {prog.title}
                        </p>
                        {prog.description && (
              ...
              <FadeBlock>
                ...
                <div className="flex flex-wrap gap-2 mb-7">
                  {country.language.levels.map((level) => (
                    <span
                      key={level}
                      className="px-4 py-2 rounded-full border border-gray-200 bg-white text-gray-600 text-sm font-medium"
                    >
                      {level}
                    </span>
                  ))}
              ...
              {/* Continuous Support */}
              {country.continuousSupport && (
                <FadeBlock>
                  <SectionLabel>Continuous Assistance</SectionLabel>
                  <h2 className="font-display text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              ...
              <FadeBlock>
                ...
                <h2 className="font-display text-3xl sm:text-4xl font-bold text-gray-900 mb-8">
                  Your Road to {country.name}
                </h2>
                    ...
                    {country.roadmap.map((item) => (
                      <div key={item.step} className="flex gap-5 items-start">
                        ...
                        <div className="pt-1.5">
                          <p className="font-display font-semibold text-gray-900 text-[16px] mb-1">
                            {item.title}
                          </p>
