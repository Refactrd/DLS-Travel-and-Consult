...
const steps = [
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
        <path
          d="M14 3C8.477 3 4 7.477 4 13c0 2.136.67 4.114 1.81 5.738L4 24l5.262-1.81A9.953 9.953 0 0014 23c5.523 0 10-4.477 10-10S19.523 3 14 3z"
          stroke="currentColor"
          strokeWidth="1.8"
          strokeLinecap="round"
          strokeLinejoin="round"
...
export default function ProcessSection() {
  ...
  useEffect(() => {
    ...
    const cards =
      cardsRef.current?.querySelectorAll<HTMLElement>(".process-card");
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(135deg, #060620 0%, #0D1B6E 55%, #0D7EFF 100%)",
      }}
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle, #0D7EFF 0%, transparent 70%)",
          }}
        />
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle at 30% 20%, rgba(13,126,255,0.12) 0%, transparent 70%)",
                }}
              />
              ...
              <div
                ...
                style={{
                  background: "rgba(13,126,255,0.15)",
                  border: "1px solid rgba(13,126,255,0.25)",
                }}
              >
                {step.icon}
              </div>
              ...
              {i < steps.length - 1 && (
                <div className="hidden md:block absolute -right-4 top-1/2 -translate-y-1/2 z-20">
                  <div
                    ...
                    style={{
                      background: "rgba(13,126,255,0.3)",
                      border: "1px solid rgba(13,126,255,0.4)",
                    }}
                  >
        ...
        <div className="text-center mt-14">
          <a
            ...
            style={{
              background: "linear-gradient(135deg, #0D7EFF 0%, #3b82f6 100%)",
              boxShadow: "0 8px 32px rgba(13,126,255,0.35)",
            }}
          >
